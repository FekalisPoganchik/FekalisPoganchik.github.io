...
function calc() {
    ...
    function getDynamicInformaiton(selector) {
    ...
    getDynamicInformaiton('#height')
    getDynamicInformaiton('#weight')
    getDynamicInformaiton('#age')
}
